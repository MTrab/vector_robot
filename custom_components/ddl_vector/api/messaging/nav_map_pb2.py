...
_NAVNODECONTENTTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_UNKNOWN", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_CLEAR_OF_CLIFF", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_OBSTACLE_CUBE", index=3, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_OBSTACLE_PROXIMITY",
            index=4,
            number=4,
            options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_OBSTACLE_PROXIMITY_EXPLORED",
            index=5,
            number=5,
            options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_OBSTACLE_UNRECOGNIZED",
            index=6,
            number=6,
            options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_CLIFF", index=7, number=7, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_INTERESTING_EDGE", index=8, number=8, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NAV_NODE_NON_INTERESTING_EDGE",
            index=9,
            number=9,
            options=None,
            type=None,
...
_NAVMAPQUADINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="content",
            full_name="Anki.Vector.external_interface.NavMapQuadInfo.content",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="depth",
            full_name="Anki.Vector.external_interface.NavMapQuadInfo.depth",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="color_rgba",
            full_name="Anki.Vector.external_interface.NavMapQuadInfo.color_rgba",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
...
_NAVMAPINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="root_depth",
            full_name="Anki.Vector.external_interface.NavMapInfo.root_depth",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="root_size_mm",
            full_name="Anki.Vector.external_interface.NavMapInfo.root_size_mm",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="root_center_x",
            full_name="Anki.Vector.external_interface.NavMapInfo.root_center_x",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="root_center_y",
            full_name="Anki.Vector.external_interface.NavMapInfo.root_center_y",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="root_center_z",
            full_name="Anki.Vector.external_interface.NavMapInfo.root_center_z",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
...
_NAVMAPFEEDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="frequency",
            full_name="Anki.Vector.external_interface.NavMapFeedRequest.frequency",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_NAVMAPFEEDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="origin_id",
            full_name="Anki.Vector.external_interface.NavMapFeedResponse.origin_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="map_info",
            full_name="Anki.Vector.external_interface.NavMapFeedResponse.map_info",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="quad_infos",
            full_name="Anki.Vector.external_interface.NavMapFeedResponse.quad_infos",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
NavMapQuadInfo = _reflection.GeneratedProtocolMessageType(
    "NavMapQuadInfo",
    (_message.Message,),
    dict(
...
NavMapInfo = _reflection.GeneratedProtocolMessageType(
    "NavMapInfo",
    (_message.Message,),
    dict(
...
NavMapFeedRequest = _reflection.GeneratedProtocolMessageType(
    "NavMapFeedRequest",
    (_message.Message,),
    dict(
...
NavMapFeedResponse = _reflection.GeneratedProtocolMessageType(
    "NavMapFeedResponse",
    (_message.Message,),
    dict(
