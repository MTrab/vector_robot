...
_CONTROLREQUEST_PRIORITY = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="OVERRIDE_BEHAVIORS", index=1, number=10, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEFAULT", index=2, number=20, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RESERVE_CONTROL", index=3, number=30, options=None, type=None
        ),
    ],
...
_BEHAVIORCONTROLREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="Anki.Vector.external_interface.BehaviorControlRequest.control_release",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Anki.Vector.external_interface.BehaviorControlRequest.control_request",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="request_type",
            full_name="Anki.Vector.external_interface.BehaviorControlRequest.request_type",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_BEHAVIORCONTROLRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="control_granted_response",
            full_name="Anki.Vector.external_interface.BehaviorControlResponse.control_granted_response",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="control_lost_event",
            full_name="Anki.Vector.external_interface.BehaviorControlResponse.control_lost_event",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="keep_alive",
            full_name="Anki.Vector.external_interface.BehaviorControlResponse.keep_alive",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="reserved_control_lost_event",
            full_name="Anki.Vector.external_interface.BehaviorControlResponse.reserved_control_lost_event",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="response_type",
            full_name="Anki.Vector.external_interface.BehaviorControlResponse.response_type",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_BEHAVIORCONTROLREQUEST.fields_by_name[
    "control_release"
].containing_oneof = _BEHAVIORCONTROLREQUEST.oneofs_by_name["request_type"]
_BEHAVIORCONTROLREQUEST.oneofs_by_name["request_type"].fields.append(
...
].message_type = _CONTROLGRANTEDRESPONSE
_BEHAVIORCONTROLRESPONSE.fields_by_name[
    "control_lost_event"
].message_type = _CONTROLLOSTRESPONSE
_BEHAVIORCONTROLRESPONSE.fields_by_name[
    "keep_alive"
].message_type = anki__vector_dot_messaging_dot_messages__pb2._KEEPALIVEPING
_BEHAVIORCONTROLRESPONSE.fields_by_name[
    "reserved_control_lost_event"
].message_type = _RESERVEDCONTROLLOSTRESPONSE
...
_BEHAVIORCONTROLRESPONSE.fields_by_name[
    "control_granted_response"
].containing_oneof = _BEHAVIORCONTROLRESPONSE.oneofs_by_name["response_type"]
_BEHAVIORCONTROLRESPONSE.oneofs_by_name["response_type"].fields.append(
...
ControlRequest = _reflection.GeneratedProtocolMessageType(
    "ControlRequest",
    (_message.Message,),
    dict(
...
BehaviorControlRequest = _reflection.GeneratedProtocolMessageType(
...
ControlGrantedResponse = _reflection.GeneratedProtocolMessageType(
...
ControlLostResponse = _reflection.GeneratedProtocolMessageType(
    "ControlLostResponse",
    (_message.Message,),
    dict(
...
ReservedControlLostResponse = _reflection.GeneratedProtocolMessageType(
    "ReservedControlLostResponse",
    (_message.Message,),
    dict(
...
BehaviorControlResponse = _reflection.GeneratedProtocolMessageType(
