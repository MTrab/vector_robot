...
_RESPONSESTATUS_STATUSCODE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="RESPONSE_RECEIVED", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="REQUEST_PROCESSING", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="OK", index=3, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FORBIDDEN", index=4, number=100, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NOT_FOUND", index=5, number=101, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_RESPONSESTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="code",
            full_name="Anki.Vector.external_interface.ResponseStatus.code",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
ResponseStatus = _reflection.GeneratedProtocolMessageType(
    "ResponseStatus",
    (_message.Message,),
    dict(
