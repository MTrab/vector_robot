...
def read_configuration(
    serial: str, name: str, logger: logging.Logger, escape_pod: bool = False
) -> dict:
    ...
    if not sections:
        ...
        raise VectorConfigurationException(
            "Could not find the sdk configuration file. Please run `python3 -m anki_vector.configure` or `python3 -m anki_vector.configure_pod` to set up your Vector for SDK usage."
        )
