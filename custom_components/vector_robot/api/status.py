...
__all__ = [
    "ROBOT_STATUS_NONE",
    "ROBOT_STATUS_ARE_MOTORS_MOVING",
    "ROBOT_STATUS_IS_CARRYING_BLOCK",
    "ROBOT_STATUS_IS_DOCKING_TO_MARKER",
...
ROBOT_STATUS_IS_CARRYING_BLOCK = protocol.RobotStatus.Value(
    "ROBOT_STATUS_IS_CARRYING_BLOCK"
)
ROBOT_STATUS_IS_DOCKING_TO_MARKER = protocol.RobotStatus.Value(
    "ROBOT_STATUS_IS_PICKING_OR_PLACING"
)
ROBOT_STATUS_IS_PICKED_UP = protocol.RobotStatus.Value("ROBOT_STATUS_IS_PICKED_UP")
ROBOT_STATUS_IS_BUTTON_PRESSED = protocol.RobotStatus.Value(
    "ROBOT_STATUS_IS_BUTTON_PRESSED"
)
...
ROBOT_STATUS_CALM_POWER_MODE = protocol.RobotStatus.Value(
    "ROBOT_STATUS_CALM_POWER_MODE"
)
...
ROBOT_STATUS_ARE_WHEELS_MOVING = protocol.RobotStatus.Value(
    "ROBOT_STATUS_ARE_WHEELS_MOVING"
)
ROBOT_STATUS_IS_BEING_HELD = protocol.RobotStatus.Value("ROBOT_STATUS_IS_BEING_HELD")
ROBOT_STATUS_IS_ROBOT_MOVING = protocol.RobotStatus.Value(
