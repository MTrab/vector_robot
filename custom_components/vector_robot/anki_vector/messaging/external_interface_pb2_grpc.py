...
class ExternalInterfaceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFeatureFlag = channel.unary_unary(
            ...
            request_serializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagRequest.SerializeToString,
            response_deserializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagResponse.FromString,
        )
        self.GetFeatureFlagList = channel.unary_unary(
            "/Anki.Vector.external_interface.ExternalInterface/GetFeatureFlagList",
            request_serializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagListRequest.SerializeToString,
            response_deserializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagListResponse.FromString,
        )
        self.GetAlexaAuthState = channel.unary_unary(
            "/Anki.Vector.external_interface.ExternalInterface/GetAlexaAuthState",
            request_serializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaAuthStateRequest.SerializeToString,
            response_deserializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaAuthStateResponse.FromString,
        )
        self.AlexaOptIn = channel.unary_unary(
            "/Anki.Vector.external_interface.ExternalInterface/AlexaOptIn",
            request_serializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaOptInRequest.SerializeToString,
            response_deserializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaOptInResponse.FromString,
        )
...
def add_ExternalInterfaceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "GetFeatureFlag": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagRequest.FromString,
            response_serializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagResponse.SerializeToString,
        ),
        "GetFeatureFlagList": grpc.unary_unary_rpc_method_handler(
            servicer.GetFeatureFlagList,
            request_deserializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagListRequest.FromString,
            response_serializer=anki__vector_dot_messaging_dot_messages__pb2.FeatureFlagListResponse.SerializeToString,
        ),
        "GetAlexaAuthState": grpc.unary_unary_rpc_method_handler(
            servicer.GetAlexaAuthState,
            request_deserializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaAuthStateRequest.FromString,
            response_serializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaAuthStateResponse.SerializeToString,
        ),
        "AlexaOptIn": grpc.unary_unary_rpc_method_handler(
            servicer.AlexaOptIn,
            request_deserializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaOptInRequest.FromString,
            response_serializer=anki__vector_dot_messaging_dot_alexa__pb2.AlexaOptInResponse.SerializeToString,
        ),
    }
